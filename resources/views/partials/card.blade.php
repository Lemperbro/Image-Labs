    ...
    <div class="relative flex flex-col mt-6 text-gray-700 bg-white shadow-md bg-clip-border rounded-xl">
        <div
            ...
            <img src="https://images.unsplash.com/photo-1540553016722-983e48a2cd10?ixlib=rb-1.2.1&amp;ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&amp;auto=format&amp;fit=crop&amp;w=800&amp;q=80"
                alt="card-image" class="object-cover h-full w-full" />
        </div>
        <div class="p-6">
            <h5
                class="block mb-2 font-sans text-xl antialiased font-semibold leading-snug tracking-normal text-blue-gray-900">
                Tingkatkan Resolusi dan Kejernihan Gambar, serta Koreksi Wajah
            </h5>
            <p class="block font-sans text-base antialiased font-light leading-relaxed text-inherit line-clamp-3">
                Fitur ini menggunakan model pembelajaran mesin Real-ESRGAN untuk meningkatkan resolusi dan kejernihan
                gambar, serta memperbaiki tampilan wajah.
            </p>
        </div>
        <div class="p-6 pt-0">
